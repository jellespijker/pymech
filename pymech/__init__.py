...
from pymech.materials import Plastic, Steel, Fluidum, BinghamFluid, Fluid, Material, Solid
...
register_class(Solid, Solid.Solid_to_builtin, Solid.Solid_from_builtin)
...
register_class(Fluidum, Fluidum.Fluidum_to_builtin, Fluidum.Fluidum_from_builtin)
